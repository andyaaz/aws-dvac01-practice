Below is generated by `sam init` with sam-web-backend starter. DynamoDB is removed from the code (thus tests are failing now. maybe I will update tests later). Everything else should still work.
